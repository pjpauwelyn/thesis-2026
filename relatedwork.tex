...
Sections~\ref{sec:rag-fundamentals}--\ref{sec:background-agents} introduce the conceptual and technical foundations of our approach; Sections~\ref{sec:rw-rag-architectures}--\ref{sec:rw-llm-judge} review related work and identify the gap we address.
...
In Earth observation, whether a piece of evidence applies to a given question depends on five semantic dimensions: \emph{what} is measured, \emph{how}, \emph{where}, \emph{when}, and \emph{why}. Searching for information on lexical similarity alone misses distinctions that are critical from a scientific standpoint.
