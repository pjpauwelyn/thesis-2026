...
\caption{Architecture of the ontology-enhanced multi-agent RAG pipeline. Grey boxes represent existing two-step baseline components; dark blue boxes represent the three new agents.}
\label{fig:pipeline}
\end{figure}
