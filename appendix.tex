...
Used by the Refinement Agent in the no-ontology variant (Section~\ref{subsec:refinement-prompt-design}).
...
The output format is otherwise identical, enabling a clean comparison.

\begin{lstlisting}[style=promptstyle,
caption={Refinement Agent prompt -- no-ontology version variant (full).},
