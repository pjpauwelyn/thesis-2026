...
- both chapter 7 and 8 need to be combined into one chapter. 

- these sections needs to be correctly combined, ordered structure and merged as necessary. everything, all semantics, should still be clear and well explained but can be made slightly more concise.

- in chapter 8, when formally answering the RQs, we need to shorten this. currently scores are given but we need to make sure it doesn't just mirror the results sections and the answers are targeted and direct, without being too redundant on top of what was already given in the results section.

- also the RQs can be answered in a structured way as they are currently but can be more relaxed, less harsh than "Evidence: ..." and "Yes. ..."

- in 8.2, we can remove full text indexing.

- also any other mention of quantitive precision, abstract only weakness, can now be enforced with the extra experiment (full text --> better quantitive precision at the cost of general answer quality)
\end{comment}
