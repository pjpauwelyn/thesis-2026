...
\paragraph{Main RQ: Can a multi-agent architecture with dynamic ontology generation reduce hallucinations and improve answer quality in domain-specific RAG systems for Earth observation queries?}
